...
# initialize plot
fig = Figure(resolution=(3048, 2160))
...
ax1 = fig[1,1] = Axis(fig,
    ...
    titlegap=48, titlesize=50,
    # x-axis
    xautolimitmargin=(0, 0), xgridwidth=2, xticklabelsize=30,
    xticks=LinearTicks(20), xticksize=18,
    # y-axis
    yautolimitmargin=(0, 0), ygridwidth=2, yticklabelpad=14,
    yticklabelsize=30, yticks=LinearTicks(20), yticksize=18
)
...
# reser axes limits, if necessary
xlims!(ax1,-10,10)
ylims!(ax1,-10,10)
...
scatter1 = scatter!(ax1, rx, ry, color=:red, marjersize=15)
...
# save plot
save("tutorial_10/sliders.png",fig)
...
buttons = buttongrid[1,1:5] = [
    Button(fig,
        label=l, height=60, width=250, textsize=15
    )
    for l in labels
]
...
scat1 = scatter!(ax1, x, y, color=c, markersizes=ms)

# reset axes limis, if necessary
xlims!(ax1,-10,10)
ylims!(ax1,-10,10)
...
# save fig
save("tutorial_10/buttons.png",fig)
...
# add scatter plot
sact1 = scatter!(ax1, x, y, color=c, markersize=ms)
...
# save plot
save("tutorial_10/menus.png",fig)