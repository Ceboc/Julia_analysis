...
df = DataFrame(CSV.File("tutorial_13/reviewbrah.csv", types=mytypes))
...
savehtml("tutorial_13/reviewbrah",df)
...
savehtml("tutorial_13/describe",df_describe)
...
savehtml("tutorial_13/df_categories",df_categories)
...
metricname = ["Rating (0 - 10)","Price (USD)","Length (minutes)"]
...
yearname = ["All Years", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020"]
...
den1 = density!(ax1,m,
    color=(:dodgerblue, 0.5), strokecolot=:black, strokewidth=2
)
...
save("tutorial_13/reviewbrah.png",fig)